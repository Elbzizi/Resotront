...
$listUsers = "bg-orange";
$users = $app->SelectAll("SELECT * from users where is_Admin = 0");
        ...
        <tbody>
          <?php foreach ($users as $value): ?>
            <tr id="<?= $value->id ?>">
              ...
              <td>
                <button onclick="deleteUser('<?= $value->id ?>')" class="btn btn-outline-danger text-white">
...
if (isset($_POST['save'])) {
  ...
  $query = 'INSERT INTO users  values (default,?,?,?,default,false)';
