...
<head>
  ...
  <link rel="stylesheet"
    href="<?= APPADM ?>assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  ...
  <div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
      ...
      <a href="<?= APPURL ?>" class="navbar-brand p-0">
        <h1 style="font-size:50px;font-weight:bolder" class="text-orange  m-0"><i
            class="fa fa-utensils me-3"></i>Restoran</h1>
            ...
            <a href="#" class="dropdown-item">
              ...
              if ($num > 0):
                foreach ($contactes as $value):
                  ...
                  <!-- Message Start -->
                  <div class="media">
                    <img src="<?= APPADM ?>assets/img/png-clipart.png" height="50px" width="50px" alt="User Avatar"
                ...
                ?>
                <a href="Message-Contact.php" class="dropdown-item dropdown-footer">Not any message today</a>
                <?php
              endif;
              ?>
              <!-- Message End -->
