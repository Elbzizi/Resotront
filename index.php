...
$app = new App();
$query1 = "SELECT * from foods where meal_id= 1";
$meal_1 = $app->SelectAll($query1);
$query2 = "SELECT * from foods where meal_id= 2";
                        ...
                        <?php foreach ($meal_1 as $meal): ?>
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center">
                                    <img class="flex-shrink-0 img-fluid rounded" src="<?= IMAG. $meal->image ?>"
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <a type="button" href="<?php echo APPURL . '/food/add-cart.php?id=' . $meal->id; ?>"
    ...
    <div class="row g-0">
        ...
        <div class="col-md-6 bg-dark d-flex align-items-center">
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <form action="Ajouter-booking.php" method="POST">
                    <div class="row g-3">
                        <div class="col-md-6">
